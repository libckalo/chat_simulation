...
class SingleChatMsg:
    ...
    def to_sub(self):
        self.is_main = False
        self.msg_bg_ninepng = SUB_BG_NINEPNG
        self.root.itemconfigure(self.msg_text_label, anchor=tkinter.NW, width=self.root.winfo_width() - 260)
    ...
    def to_main(self):
        ...
        self.root.itemconfigure(self.msg_text_label, anchor=tkinter.NE, width=width - 260)
